...
engine.say("Los productos disponibles son: pescado, cachama, tilapia, bagre y cabeza de pescado")
engine.runAndWait()
...
engine.say(f"Sugerencia del día: {producto_aleatorio}, {productos_disponibles[producto_aleatorio]} pesos")
engine.runAndWait()
